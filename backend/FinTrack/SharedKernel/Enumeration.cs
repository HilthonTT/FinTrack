    ...
    where TEnum : Enumeration<TEnum>
{
    ...
    {
        bool hasValue = EnumerationsDictionary.Value.TryGetValue(id, out TEnum? enumeration);
        if (hasValue)
        {
            return enumeration;
        }
    ...
    {
        return EnumerationsDictionary.Value.Values.SingleOrDefault(x => x.Name == name);
    }
